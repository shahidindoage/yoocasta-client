    ...
    <div className="max-w-6xl mx-auto  px-4 sm:px-8 py-10 min-h-screen ">
      <div className="space-y-8 ">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-[#3835A4] uppercase">My Applications</h1>
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-extrabold tracking-widest text-stone-400 uppercase">Sort</span>
            <select
              value={sort}
        ...
        {loading ? (
          ...
          <div className="text-center py-20 space-y-4">
            ...
            <Link to="/browse-jobs" className="inline-block text-[10px] font-black uppercase tracking-widest bg-[#C6007E] text-white px-6 py-3 rounded-xl hover:bg-[#a10065] transition-all">
              Browse Jobs
            </Link>
          </div>
        ) : (
              ...
              return (
                <div key={app.id} className="bg-white border-2 border-stone-100 rounded-2xl p-5 sm:p-6 hover:border-[#3835A4]/20 transition-all shadow-sm hover:shadow-md">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    {/* Status Chip */}
                    <span
                      className="shrink-0 text-[9px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg"
                  ...
                  <div className="flex items-center justify-between mt-4 pt-3 border-t border-stone-50">
                    ...
                    <Link
                      ...
                      className="text-[9px] font-black uppercase tracking-wider bg-[#3835A4] text-white px-3.5 py-2 rounded-lg hover:bg-[#2a2899] transition-all"
                    >
                      View Shortlisted
                    </Link>
                  </div>
